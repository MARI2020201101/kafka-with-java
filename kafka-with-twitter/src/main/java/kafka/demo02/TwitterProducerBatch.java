...
public class TwitterProducerBatch {
    private static final Logger logger = LoggerFactory.getLogger(TwitterProducerBatch.class);

    public TwitterProducerBatch() {}

    public static void main(String[] args) {
        new TwitterProducerBatch().run();
    }
